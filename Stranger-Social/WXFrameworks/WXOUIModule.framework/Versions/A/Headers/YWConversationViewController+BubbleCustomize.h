...
// 是否插入信息面板
- (BOOL)messagesList:(YWConversationViewController *)msgsListVC shouldShowDetail4Link:(NSString *)linkUrl;

// 信息面板尺寸
- (CGSize)messagesList:(YWConversationViewController *)msgsListVC detailViewSize4Link:(NSString *)linkUrl;

// 信息面板
- (UIView *)messagesList:(YWConversationViewController *)msgsListVC detailView4Link:(NSString *)linkUrl;
